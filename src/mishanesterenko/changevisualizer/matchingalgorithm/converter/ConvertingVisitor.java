package mishanesterenko.changevisualizer.matchingalgorithm.converter;
 ...
 *
 */
public class ConvertingVisitor extends ASTVisitor {
    private IProgressMonitor progressMonitor;

    private Stack<ASTNode> astNodeStack;

    private Stack<Node> nodeStack;

    private Node currentNode;

    public ConvertingVisitor(final IProgressMonitor monitor) {
        progressMonitor = monitor == null ? new NullProgressMonitor() : monitor;
        astNodeStack = new Stack<ASTNode>();
